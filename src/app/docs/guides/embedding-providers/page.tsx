      ...
      <div className="space-y-10">
        ...
        <section>
          ...
          <p className="text-muted-foreground mb-3">
            No configuration needed beyond the API key. Produces 768D vectors matching the database
            schema.
          </p>
...
EMBEDDING_PROVIDER=google`}</Code>
        ...
        <section>
          ...
          <p className="text-muted-foreground mb-3">
            ...
            <strong>You must run a database migration</strong> to change the vector column from 768
            to 1536 dimensions before switching.
          </p>
